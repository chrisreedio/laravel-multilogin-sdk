...
class ProfileUpdate extends Request implements HasBody
{
	...
	/**
	 * @param null|string $autoUpdateCore `Optional`. Setting to True allows passing "core_version" and "core_minor_version".
	 ...
	 * @param null|string $audioMaskingGraphicsNoisePortsMasking `Required` for `flags`.
	 * @param null|string $proxyMasking `Required` for `flags`.
	 * @param null|string $geolocationPopup `Required` for `flags`.
	 * @param null|string $navigatorMaskingLocalizationMaskingTimezoneMaskingGraphicsMaskingFontsMaskingMediaDevicesMaskingScreenMasking `Required` for `flags`.
	 * @param null|string $geolocationMasking `Required` for `flags`.
	 * @param null|string $autoUpdateCore `Optional`. You can skip specifying the value since your profiles will be updated to the latest core by default each time it is launched.
